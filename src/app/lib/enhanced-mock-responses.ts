  ...
  if (vendorName.toLowerCase().includes('chef art smith') || 
    ...
    for (const qa of chefArtSmithQA.questions) {
      ...
      if (normalizedQuestion === predefinedQuestion ||
        ...
        // Return structured data for the new component
        ...
        return {
          role: "assistant",
          content: qa.answer, // Fallback for systems that don't use structured data
          structuredData,
...
// Keep existing functions for summaries (they use traditional format)
